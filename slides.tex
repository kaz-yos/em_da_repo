...
\begin{frame}[label={sec:orgf193a11}]{EM Algorithm Applications}
\begin{itemize}
...
\label{sec:org8d2c059}
\begin{frame}[label={sec:orgf9d4473}]{A Coin-Flipping Experiment}
\begin{itemize}
...
\label{sec:org502a1e0}
\begin{frame}[label={sec:org0a80c98}]{Complete-Data Maximum Likelihood}
\begin{itemize}
...
\begin{frame}[label={sec:org5f61dcd}]{Complete-Data Likelihood Visualization}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\item See the \hyperlink{eq:orgf992aaf}{likelihood expression}.
\end{itemize}
\end{column}
...
\label{sec:org1676073}
\begin{frame}[label={sec:orgca1a26b}]{A Contrived Coin-Flipping Experiment}
\begin{itemize}
...
\item These maximize the \hyperlink{eq:org95116d1}{expected log likelihood}.
\end{itemize}
\end{frame}
...
\begin{frame}[label={sec:org4f113b5},fragile]{EM Step (2)}
 \scriptsize
\begin{minted}[frame=lines,linenos=false]{r}
...
\begin{frame}[label={sec:orgd3523e8}]{Visual Representation of Iteration}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org09fb0c3}]{Multiple Initialization and Label Indeterminancy}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org894fef4}]{Incomplete-Data Likelihood}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
\item In this specific instance, the \hyperlink{eq:org7f6205f}{incomplete-data likelihood} can be graphed with grid search as the parameter space is small and low dimensional ([0,1]\textsuperscript{2}).
...
\begin{frame}[label={sec:org1c4101c}]{EM: Incomplete-Data Likelihood}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org7b368c2}]{EM: E Step (0)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org9065e41}]{EM: M Step (0)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgc3291ef}]{EM: E Step (1)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgb57dd7f}]{EM: M Step (1)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgb9f5664}]{EM: E Step (2)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org16c3a96}]{EM: M Step (2)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgc3912d8}]{EM: E Step (3)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgf68b45c}]{EM: M Step (3)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgc6bf388}]{EM: E Step (4)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org69ce695}]{EM: M Step (4)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org83cbd90}]{EM: E Step (5)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgedb7a94}]{EM: M Step (5)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\label{sec:org4a8d01e}
\appendix
\begin{frame}[label={sec:orgf68c95a}]{}
\begin{center}
...
\section{DA Method}
\label{sec:org5c7fb27}
\appendix
\begin{frame}[label={sec:orgd47ae7e}]{}
\begin{center}
\resizebox{\linewidth}{!}{Data Augmentation Method}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgf231f09}]{From EM to DA}
\begin{itemize}
...
\begin{frame}[label={sec:orgf70c88c}]{Model Configuration}
\begin{itemize}
...
\begin{frame}[label={sec:org3011f9e}]{Parameter Initialization}
\begin{itemize}
\item Randomly initialize the parameters
\begin{itemize}
\item \(\theta_{0}^{(0)} := 0.6\)
...
\begin{frame}[label={sec:org400a861}]{Visual Representation of Initial Iterations}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org704ce2d}]{Visual Representation of Posterior Samples}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org68ad3a6}]{Visual Representation of Posterior Density}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
\item The first 10\% of posterior samples were discarded to reduce the influence of the initialization values.
...
\begin{frame}[label={sec:org3740a36}]{DA: Animation}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
\item Incomplete-data likelihood function.
...
\section{Stan}
\label{sec:org7027187}
\appendix
\begin{frame}[label={sec:org345ec33}]{}
\begin{center}
\resizebox{\linewidth}{!}{Sampling Using Stan}
\end{center}
\end{frame}

\begin{frame}[label={sec:org3fbb8ff}]{Stan: Hamiltonian Monte Carlo}
\begin{itemize}
...
\begin{frame}[label={sec:orgea34d58}]{Stan Diagnostic Plots}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgf741acb}]{Visual Representation of Stan Initial Iterations}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org5845a50}]{Stan Posterior Samples}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org23408a6}]{Stan Diagnostic Plots (Ordered Prior)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgccadd6e}]{Visual Representation of Stan Initial Iterations (Ordered Prior)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org303a6f9}]{Stan Posterior Samples (Ordered Prior)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
