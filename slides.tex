...
\begin{frame}[label={sec:org9de2071}]{EM Algorithm Applications}
\begin{itemize}
...
\label{sec:org087caaf}
\begin{frame}[label={sec:org7bb652c}]{A Coin-Flipping Experiment}
\begin{itemize}
...
\begin{frame}[label={sec:orgace2faf}]{A Coin-Flipping Experiment (More Formal)}
\begin{itemize}
\item Two coins \(A\) (0) and \(B\) (1) with unknown head probabilities \((\theta_{0},\theta_{1})\)
\item For \(i = 1, \dots, 5\)
\begin{enumerate}
...
\label{sec:org8969c91}
\begin{frame}[label={sec:org74aa41d}]{Complete-Data Maximum Likelihood}
\begin{itemize}
...
\begin{frame}[label={sec:org2cd99a9}]{Complete-Data Likelihood Visualization}
\begin{columns}
...
\item See the \hyperlink{eq:org9bf4fac}{likelihood expression}.
\end{itemize}
\end{column}
...
\label{sec:org188ee55}
\begin{frame}[label={sec:org9c69f01}]{A Contrived Coin-Flipping Experiment}
\begin{itemize}
...
\label{sec:orgd2f2888}
\begin{frame}[label={sec:org64ccc36}]{}
\begin{center}
\resizebox{\linewidth}{!}{Expectation-Maximization Algorithm}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgf7dc47d}]{EM Algorithm to the Rescue}
\begin{itemize}
...
\begin{frame}[label={sec:org8116e5c}]{}
\begin{center}
...
\begin{frame}[label={sec:orgbf4d83e}]{Parameter Initialization}
\begin{itemize}
...
\item These maximize the \hyperlink{eq:org12b665e}{expected log likelihood}.
\end{itemize}
\end{frame}
...
\begin{frame}[label={sec:org69393cc},fragile]{EM Step (2)}
 \scriptsize
\begin{minted}[frame=lines,linenos=false]{r}
...
\begin{frame}[label={sec:org03ef66f}]{Visual Representation of Iteration}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org84df443}]{Multiple Initialization and Label Indeterminancy}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org46d3921}]{Incomplete-Data Likelihood}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
\item In this specific instance, the \hyperlink{eq:orgeaa8e48}{incomplete-data likelihood} can be graphed with grid search as the parameter space is small and low dimensional ([0,1]\textsuperscript{2}).
...
\begin{frame}[label={sec:org3f35d28}]{EM: Incomplete-Data Likelihood}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgb253fc4}]{EM: E Step (0)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org434d306}]{EM: M Step (0)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org4967e99}]{EM: E Step (1)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org2f7474f}]{EM: M Step (1)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgda9b5a5}]{EM: E Step (2)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org77943c7}]{EM: M Step (2)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgfe76f46}]{EM: E Step (3)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgdd49fa7}]{EM: M Step (3)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org4dccab9}]{EM: E Step (4)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgdad59cc}]{EM: M Step (4)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org8eea93c}]{EM: E Step (5)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org8151266}]{EM: M Step (5)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\label{sec:org1fb702f}
\appendix
\begin{frame}[label={sec:orgaa5c6f5}]{}
\begin{center}
...
\section{DA Method}
\label{sec:orgc38518e}
\appendix
\begin{frame}[label={sec:orge426ece}]{}
\begin{center}
\resizebox{\linewidth}{!}{Data Augmentation Method}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgba8e328}]{From EM to DA}
\begin{itemize}
...
\begin{frame}[label={sec:org72b964e}]{Model Configuration}
\begin{itemize}
...
\begin{frame}[label={sec:orgbcdd2fe}]{Parameter Initialization}
\begin{itemize}
\item Randomly initialize the parameters
\begin{itemize}
\item \(\theta_{0}^{(0)} := 0.6\)
...
\begin{frame}[label={sec:orgac13b00}]{Visual Representation of Initial Iterations}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org34c1312}]{Visual Representation of Posterior Samples}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgb8df214}]{Visual Representation of Posterior Density}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
\item The first 10\% of posterior samples were discarded to reduce the influence of the initialization values.
...
\begin{frame}[label={sec:org864e7fd}]{DA: Animation}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
\item Incomplete-data likelihood function.
...
\section{Stan}
\label{sec:orga462918}
\appendix
\begin{frame}[label={sec:orgddf5829}]{}
\begin{center}
\resizebox{\linewidth}{!}{Sampling Using Stan}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgb7abffc}]{Stan: Hamiltonian Monte Carlo}
\begin{itemize}
...
\begin{frame}[label={sec:orgbd23661}]{Stan Diagnostic Plots}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgca4ef23}]{Visual Representation of Stan Initial Iterations}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org7995788}]{Stan Posterior Samples}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org33cab1e}]{Stan Diagnostic Plots (Ordered Prior)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org1797768}]{Visual Representation of Stan Initial Iterations (Ordered Prior)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgbec30de}]{Stan Posterior Samples (Ordered Prior)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
