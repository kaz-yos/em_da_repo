...
\label{sec:org11d2f8b}
\begin{frame}[label={sec:org1e99c0e}]{A Coin-Flipping Experiment}
\begin{itemize}
...
\begin{frame}[label={sec:orgc005211}]{A Coin-Flipping Experiment (More Formal)}
\begin{itemize}
\item Two coins \(A\) (0) and \(B\) (1) with unknown head probabilities \((\theta_{0},\theta_{1})\)
\item For \(i = 1, \dots, 5\)
\begin{enumerate}
...
\label{sec:org4f432af}
\begin{frame}[label={sec:orgdf07d99}]{Complete-Data Maximum Likelihood}
\begin{itemize}
...
\label{sec:orgbef0142}
\begin{frame}[label={sec:orgd4eead4}]{A Contrived Coin-Flipping Experiment}
\begin{itemize}
...
\label{sec:org0f33551}
\begin{frame}[label={sec:org37e0e81}]{}
\begin{center}
\resizebox{\linewidth}{!}{Expectation-Maximization Algorithm}
\end{center}
\end{frame}

\begin{frame}[label={sec:org302445e}]{EM Algorithm to the Rescue}
\begin{itemize}
...
\begin{frame}[label={sec:orgaae628f}]{}
\begin{center}
...
\begin{frame}[label={sec:org7361f40}]{Parameter Initialization}
\begin{itemize}
...
\begin{frame}[label={sec:org39eb089},fragile]{EM Step (2)}
 \scriptsize
\begin{minted}[frame=lines,linenos=false]{r}
...
\begin{frame}[label={sec:org235f63b}]{Visual Representation of Iteration}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgc783fa3}]{Multiple Initialization and Label Indeterminancy}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org8c413af}]{EM: E Step (0)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org1296ded}]{EM: M Step (0)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org3f90f5c}]{EM: E Step (1)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org04a8637}]{EM: M Step (1)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org46f41e5}]{EM: E Step (2)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgb408ee1}]{EM: M Step (2)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orga86c6c3}]{EM: E Step (3)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgaa0b426}]{EM: M Step (3)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgcb688a2}]{EM: E Step (4)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgaefa1e2}]{EM: M Step (4)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orge2b54ef}]{EM: E Step (5)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org85ab4a3}]{Visual Representation of Initial Iterations}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org1b34581}]{Visual Representation of Posterior Samples}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
