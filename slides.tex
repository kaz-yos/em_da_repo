...
\begin{frame}[label={sec:org339c179}]{EM Algorithm Applications}
\begin{itemize}
...
\label{sec:orgb9344bf}
\begin{frame}[label={sec:org7086c67}]{A Coin-Flipping Experiment}
\begin{itemize}
...
\begin{frame}[label={sec:org1bda553}]{A Coin-Flipping Experiment (More Formal)}
\begin{itemize}
\item Two coins \(A\) (0) and \(B\) (1) with unknown head probabilities \((\theta_{0},\theta_{1})\)
\item For \(i = 1, \dots, 5\)
\begin{enumerate}
...
\label{sec:org39a1182}
\begin{frame}[label={sec:org38fbdb1}]{Complete-Data Maximum Likelihood}
\begin{itemize}
...
\begin{frame}[label={sec:org4abdd99}]{Complete-Data Likelihood Visualization}
\begin{columns}
...
\item See the \hyperlink{eq:org06354f3}{likelihood expression}.
\end{itemize}
\end{column}
...
\label{sec:orgea6fde4}
\begin{frame}[label={sec:org79fcf65}]{A Contrived Coin-Flipping Experiment}
\begin{itemize}
...
\label{sec:orge51736c}
\begin{frame}[label={sec:orgc75a67f}]{}
\begin{center}
\resizebox{\linewidth}{!}{Expectation-Maximization Algorithm}
\end{center}
\end{frame}

\begin{frame}[label={sec:org2d28237}]{EM Algorithm to the Rescue}
\begin{itemize}
...
\begin{frame}[label={sec:org5172dd8}]{}
\begin{center}
...
\begin{frame}[label={sec:org2ad6074}]{Parameter Initialization}
\begin{itemize}
...
\item These maximize the \hyperlink{eq:org9f7abd0}{expected log likelihood}.
\end{itemize}
\end{frame}
...
\begin{frame}[label={sec:org2c949db},fragile]{EM Step (2)}
 \scriptsize
\begin{minted}[frame=lines,linenos=false]{r}
...
\begin{frame}[label={sec:orge6e00f8}]{Visual Representation of Iteration}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org8c6a755}]{Multiple Initialization and Label Indeterminancy}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgfbc7134}]{Incomplete-Data Likelihood}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
\item In this specific instance, the \hyperlink{eq:org42c77c5}{incomplete-data likelihood} can be graphed with grid search as the parameter space is small and low dimensional ([0,1]\textsuperscript{2}).
...
\begin{frame}[label={sec:org1e71534}]{EM: Incomplete-Data Likelihood}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org4d7b3ca}]{EM: E Step (0)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org477cdbb}]{EM: M Step (0)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org14a69e9}]{EM: E Step (1)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org65f8c95}]{EM: M Step (1)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org5882814}]{EM: E Step (2)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgfeaacf7}]{EM: M Step (2)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org01893ca}]{EM: E Step (3)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org6cf04c1}]{EM: M Step (3)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgf6669b4}]{EM: E Step (4)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orge3cb0b3}]{EM: M Step (4)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgf0e9c91}]{EM: E Step (5)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org497aeff}]{EM: M Step (5)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\label{sec:orga0a7175}
\appendix
\begin{frame}[label={sec:orgff87b7c}]{}
\begin{center}
...
\section{DA Method}
\label{sec:orga3444c4}
\appendix
\begin{frame}[label={sec:org0958b5c}]{}
\begin{center}
\resizebox{\linewidth}{!}{Data Augmentation Method}
\end{center}
\end{frame}

\begin{frame}[label={sec:org97ef8aa}]{From EM to DA}
\begin{itemize}
...
\begin{frame}[label={sec:org766340f}]{Model Configuration}
\begin{itemize}
...
\begin{frame}[label={sec:org375800c}]{Parameter Initialization}
\begin{itemize}
\item Randomly initialize the parameters
\begin{itemize}
\item \(\theta_{0}^{(0)} := 0.6\)
...
\begin{frame}[label={sec:orgad11c2c}]{Visual Representation of Initial Iterations}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgb8266fd}]{Visual Representation of Posterior Samples}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org4c2dde5}]{Visual Representation of Posterior Density}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
\item The first 10\% of posterior samples were discarded to reduce the influence of the initialization values.
...
\begin{frame}[label={sec:orgf16dc49}]{DA: Animation}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
\item Incomplete-data likelihood function.
...
\section{Stan}
\label{sec:orgdd0290a}
\appendix
\begin{frame}[label={sec:orgba2cd19}]{}
\begin{center}
\resizebox{\linewidth}{!}{Sampling Using Stan}
\end{center}
\end{frame}

\begin{frame}[label={sec:orga87353a}]{Stan: Hamiltonian Monte Carlo}
\begin{itemize}
...
\begin{frame}[label={sec:orgec3fbbf}]{Stan Diagnostic Plots}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org7182219}]{Visual Representation of Stan Initial Iterations}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgabe220b}]{Stan Posterior Samples}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org63b32f2}]{Stan Diagnostic Plots (Ordered Prior)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgbf23c8d}]{Visual Representation of Stan Initial Iterations (Ordered Prior)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgebc4be9}]{Stan Posterior Samples (Ordered Prior)}
\begin{columns}
\begin{column}{0.50\columnwidth}
\begin{itemize}
