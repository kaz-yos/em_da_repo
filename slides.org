...
- However, HMC cannot handle discrete parameters, so the latent state have to be integrated (summed) out of the posterior (marginal posterior). cite:standevelopmentteamStanUserGuide2019 (Chapter 7)
